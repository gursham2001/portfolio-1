    ...
    <div className='projects' id='projects'>
      ...
      <div className="container">
        <div className="project-container">
          ...
          <div className="text">
            <h4 className='project-headers'>Sith Invaders</h4>
        ...
        <div className="project-container">
          ...
          <div className="text">
            <h4 className='project-headers'>SuperHeroes</h4>
        ...
        <div className="project-container">
          ...
          <div className="text">
            <h4 className='project-headers'>Trippy-Maps</h4>
        ...
        <div className="project-container">
          ...
          <div className="text">
            <h4 className='project-headers'>Project Expo</h4>
        ...
        <div className="project-container">
          ...
          <div className="text">
            <h4 className='project-headers'>Digi Clock</h4>
        ...
        <div className="project-container">
          ...
          <div className="text">
            <h4 className='project-headers'>Calculator</h4>
